...
// if (!container) {
//     console.error('❌ Container dengan data-api-endpoint tidak ditemukan!');
// } else {
//     console.log("✅ API endpoint:", container.dataset.apiEndpoint);
//     console.log("✅ Product detail template:", container.dataset.productDetailUrlTemplate);
// }
