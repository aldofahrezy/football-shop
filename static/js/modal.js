document.addEventListener('DOMContentLoaded', function() {
  ...
  async function handleFormSubmit(event) {
    ...
    const currentMode = currentProductId ? 'edit' : 'create';
  ...
  async function performDelete() {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // --- PERUBAHAN DI SINI ---
        // Tunggu sebentar agar pengguna bisa melihat notifikasi, lalu redirect.
        setTimeout(() => {
            window.location.href = "/"; // URL halaman utama
        }, 1000); // 1 detik
      ...
      // Tombol reset hanya akan terjadi jika delete gagal (karena jika sukses halaman akan redirect)
